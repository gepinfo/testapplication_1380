...
const Header = () => {
    ...
    const openNav = () => {
      ...
      let mySidenavs = document.getElementById("mySidenav")
        ...
        if(mySidenavs){
            mySidenavs.style.backgroundColor = "#1E1E1E";
        }
        if(foot){
    ...
    useEffect(() => {
        ...
        console.log('decodedToken.decodedToken?.role',decodedToken.decodedToken?.role);
                                    ...
                                    <div id="i60c7-2" className="gdp-row gpd-grid">
                                        ...
                                        {check ? (<div id="icrvgp" className="cell gpd-clm"  >
                                            <div id="i6vd27" className="gdp-row gpd-grid"  >
                                                ...
                                                <div id="iytw4t" className="cell gpd-clm" >
                                                    <a id="i9imej" className="gpd-text" href="#employeemanagement" data-toggle="collapse" data-parent="#MainMenu">employeemanagement <i className="fa fa-caret-down"></i></a>
                                                </div>
                                            </div>
                                        </div>) : <></>}
                                        {check ? (<div className="collapse" id="employeemanagement">
                                            <div id="icrvgp" className="cell gpd-clm">
                                                <div id="i6vd27" className="gdp-row gpd-grid">
                                                    <div id="iytw4t" className="cell gpd-clm">
                                                        <a id="i9imej" className="gpd-text" href='/saveemployeescreen'>SaveEmployeeScreen</a>

                                                        <a id="i9imej" className="gpd-text" href='/listemployeescreen'>listemployeescreen</a>
