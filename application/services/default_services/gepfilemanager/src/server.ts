...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_testapplication_1380;
            let db_auth = result.data.DB_AUTH_testapplication_1380;
            let db_coll = result.data.DB_COLL_testapplication_1380;
